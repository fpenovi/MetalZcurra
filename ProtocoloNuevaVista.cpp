...
string ProtocoloNuevaVista::toString(){
    ...
    string msj = id + "$" + sprite + "$" + posx + "$" + posy + "\n";
    return msj;
}

void ProtocoloNuevaVista::parse(string stream, int* id, int* sprite, int* posx, int* posy) {
    ...
    string* variables[] = {&id_s, &sprite_s, &posx_s, &posy_s};
